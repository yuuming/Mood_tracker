...
export default class SignIn extends Component {
  ...
  render() {
    return (
      <View style={{ flex: 1 }}>
        <View style={styles.moodJarIconContainerView}>
          <Image
        ...
        <KeyboardAvoidingView style={styles.textInputContainer} enabled>
          ...
          <TextInput
            ...
            // placeholder="(Min 8 letter at least 1 uppercase and digit)"
            onChangeText={password => this.setState({ password })}
            value={this.state.password}
            secureTextEntry
            underlineColorAndroid="transparent"
          />
          <Text style={styles.textStyle}>Min 8 letter at least 1 uppercase and digit</Text>
          ...
          <TouchableOpacity
            onPress={() => {
              this.setState({ isResetEmailDialogVisible: true });
            }}
          >
          ...
          {this.state.isResetEmailDialogVisible ? (
            <ResetEmailDialog
              closeDialog={this.switchResetPasswordDialogVisibility}
            />
          ) : null}
        </KeyboardAvoidingView>
        <View
